...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
      ...
      self.data = @[
        @[@{kStoryTitleKey: @"Breaking Bad Finale", kStoryImageKey: @"breakingbad.jpeg"}],
        @[@{kStoryTitleKey: @"James Goldolfini", kStoryImageKey: @"sopranos.jpg"}],
        @[@{kStoryTitleKey: @"Fender's 70th Anniversary", kStoryImageKey: @"fender.png"}],
        @[@{kStoryTitleKey: @"Led Zeppelin Reunion", kStoryImageKey: @"ledzeppelin.png"}]
      ];
    }
    return self;
}
